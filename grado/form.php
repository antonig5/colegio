...
<body>
    ...
    try {
        ...
        $sql = "SELECT  * from grados  where idGrado=:co"; //consulta con marcador, el marcador es :codigo
                ...
                <form action="actualizar.php" method="get" class="form-label">
                    ...
                    <table class="table table-dark table-striped">
                        <tr align="center" class="table-dark">
                            <td align="">
                                <h5>ID<input type="text" readonly name="documento" value="<?php echo $registro['idGrado'] ?>">
                            </td>
                            </h5>
                        </tr>
                        <tr align="center" class="table-dark">
                            <td align="">
                                <h5>Grado<input type="text" name="nombre" value="<?php echo $registro['grado'] ?>">
                            </td>
                            </h5>
                        </tr>

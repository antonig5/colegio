            ...
            <body style="background-color: #3e8ef7;">
                <div class="row justify-content-center mt-5">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title pb-2">Codigo Nº <? echo $registro['idMa'] ?></h5>
                            <a type="button" class="btn-close" style="position: relative; left:14rem; top:-3rem" href="materias.php"></a>
                            <p class="fw-bold"> Materia: <? echo $registro['materia'] ?> </p>
                            <p class="fw-bold"> Horas: <? echo $registro['horas'] ?> </p>

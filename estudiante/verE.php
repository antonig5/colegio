...
<body>
    ...
    try {
        ...
        $sql = "SELECT  * from estudiantes    where idEs=:co";
            ...
            <body style="background-color: #3e8ef7;">
                <div class="row justify-content-center mt-5">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title pb-2">Documento Nº <? echo $registro['idEs'] ?></h5>
                            <a type="button" class="btn-close" style="position: relative; left:14rem; top:-3rem" href="estudiantes.php"></a>
